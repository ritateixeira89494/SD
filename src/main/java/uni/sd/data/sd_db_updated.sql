...
CREATE TABLE IF NOT EXISTS `sd_db`.`voo` (
  ...
  `Ocupacao` INT NULL DEFAULT NULL,
...
-- -----------------------------------------------------
-- Table `sd_db`.`ocupacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `sd_db`.`ocupacao` (
  `idOcupacao` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `idVoo` INT UNSIGNED NOT NULL,
  `data` DATETIME NOT NULL,
  `ocupacao` INT NULL DEFAULT NULL,
  PRIMARY KEY (`idOcupacao`),
  INDEX `fk_idVoo_idx` (`idVoo` ASC) VISIBLE,
  CONSTRAINT `fk_idVoo`
    FOREIGN KEY (`idVoo`)
